export default function PrivacyPolicyPage() {
  return (
    <section className="max-w-5xl mx-auto px-4 py-12 text-gray-800">
      ...
      <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold  bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
    text-transparent leading-tight mb-6 font_family_jakarta">
        Privacy Policy
      </h1>
    ...
    text-transparent">8. Policy Updates</h2>
      ...
      <div className="mt-8 p-4 bg-gray-100 border-l-4 border-gray-400 rounded">
        <h2 className="text-xl font-semibold mb-2  bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">Need Help?</h2>
        ...
        <p className="mt-2 font-medium">
          ✉️ <a href="mailto:support@ghrig.com" className=" bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
