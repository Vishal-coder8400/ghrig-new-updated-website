export default function TermsPage() {
  return (
    <section className="max-w-5xl mx-auto px-4 py-12 text-gray-800">
      ...
      <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6 font_family_jakarta   bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">
      ...
      <p className="mb-6 text-lg">
        Welcome to <strong className=" bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">gHRig People Solutions</strong>. By accessing this section of our platform,
      ...
      {/* Section 1 */}
      <div className="mb-6">
        <h2 className="text-2xl font-semibold mb-2  bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">1. Acceptance of Usage</h2>
        <p>
    ...
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">2. Account & Content Responsibility</h2>
        <p>
    ...
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">3. Data Protection & Usage</h2>
        <p>
    ...
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">4. Service Modification</h2>
        <p>
          gHRig People Solutions reserves the right to modify, upgrade, or discontinue services temporarily or permanently without prior notice.
    ...
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">5. External Linking Policy</h2>
        <p>
    ...
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">6. Rights Restriction</h2>
        <p>
          Platform content, UI structure, brand assets, codes, or system flow cannot be copied, reproduced, distributed,
          or commercially reused without written permission from gHRig People Solutions.
        </p>
      </div>
    ...
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">7. Policy Updates</h2>
        <p>
      ...
      <div className="mt-8 p-4 bg-gray-100 border-l-4 border-gray-400 rounded">
        <p>
          ...
          <br />
          📩 <strong className=" bg-gradient-to-r
    from-[#8E2C6D]
    via-[#7A3FA2]
    to-[#4B4DB5]
    bg-clip-text
    text-transparent">connect@ghrig.com</strong>
        </p>
      </div>
    </section>
  );
